...
::: {.aside}
The zip object is an example of a [generator](https://wiki.python.org/moin/Generators) which we will talk more about in future lectures.
:::
...
Functions are defined using `def`, arguments can be defined with or without default values. (Arguments with defaults *must* must follow the arguments without defaults)
